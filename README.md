...
Note: I haven't really made anything with C# since college, and I wanted to grow more in backend development, so I decided to make a RESTful API with ASP.NET Core as my backend for my event planning app! 

Frontend Repo: https://github.com/jpassehl/event-planning-frontend 
